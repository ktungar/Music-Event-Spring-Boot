package com.kunal.eventful.MusicEvent.service.impl;
			...
			try {
				...
				for (int i = 0; i < jsonArray.length(); i++) {
					...
					for (int j = 0; j < eventArray.length(); j++) {
						...
						musicEventRequestResponce.setEventTitle(eventObject.getString("title"));
						musicEventRequestResponce.setEventStartTime(eventObject.getString("start_time"));
						musicEventRequestResponce.setEventVenueUrl(eventObject.getString("venue_url"));
